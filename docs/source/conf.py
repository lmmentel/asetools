# -*- coding: utf-8 -*-
#
# asetools documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'asetools.tex', u'asetools Documentation',
...
man_pages = [
    (master_doc, 'asetools', u'asetools Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'asetools', u'asetools Documentation',
   author, 'asetools', 'One line description of project.',
   'Miscellaneous'),
]
